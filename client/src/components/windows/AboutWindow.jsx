    ...
    <div className="about-window">
      ...
      {data.openTo?.length > 0 && (
        <div className="about-section">
          <h2 className="section-label">Open to</h2>
      ...
      <div className="about-links">
        {data.github && (
          <a href={data.github} target="_blank" rel="noreferrer" className="about-link" aria-label="GitHub profile">
        ...
        {data.linkedin && (
          <a href={data.linkedin} target="_blank" rel="noreferrer" className="about-link" aria-label="LinkedIn profile">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
        ...
        {data.email && (
          <a href={`mailto:${data.email}`} className="about-link" aria-label={`Email ${data.name}`}>
